...
class Mute:
    ...
    def interactive_mute(self, ax, data):
        ...
        print("Draw the mute polygon on the plot.")
    ...
    def on_select_polygon(self, verts):
        ...
        return self.apply_polygon_mute()
    ...
    def apply_polygon_mute(self):
        ...
        for i, trace in enumerate(self.data.T):  # Iterate over traces
