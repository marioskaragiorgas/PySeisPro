...
from PyQt5.QtWidgets import (
    QApplication, QMainWindow, QVBoxLayout, QToolBar, QAction, QFileDialog, QInputDialog, QWidget, QMessageBox
)
    ...
    def extract_and_plot_horizons(self):
        ...
        try:
            ...
            for region in regions:
                ...
                self.ax.scatter(trace_coords, sample_coords, color='red', s=5)  # Mark horizon points with red dots
